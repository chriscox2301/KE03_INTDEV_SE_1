...
| KR4  | Klant weet of de bestelling succesvol is                               | Could have  |
...
# Usecases 
- UC7: Klant plaatst een bestelling
- UC8: Klant bekijkt orderhistorie

# Use case Beschrijvingen

| Usecase                 | UC7: Klant plaatst een bestelling                                                                                 |                                                                             |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
...
| 1                       | De klant opent de bestelpagina                                                                                    |                                                                             |
| 2                       |                                                                                                                   | Het systeem toont een lijst van beschikbare producten met prijzen           |
| 2a                      |                                                                                                                   | Het systeem toont dat er geen producten beschikbaar zijn                    |
...
| Usecase                 | UC8: Klant bekijkt orderhistorie                                                                                  |                                                                                |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
...
| Pre-Conditions          | De klant heeft de applicatie geopend                                                                              |                                                                                |
...
| 2                       |                                                                                                                   | Het systeem toont een overzicht van alle eerdere bestellingen                  |
